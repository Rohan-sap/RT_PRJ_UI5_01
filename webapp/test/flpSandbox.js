		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PDF VIEWER",
									"targetURL": "#arcomzrtdemopdfviewer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomzrtdemopdfviewer-display": {
								"semanticObject": "arcomzrtdemopdfviewer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.zrtdemopdfviewer",
									"url": sap.ui.require.toUrl("ar/com/zrtdemopdfviewer")
								}
							}
						}
					}
